...
| M7_todas_finbert | 6 | 0.4982 | 0.493 | 0.489 | 0.449 | 0/6 | no |
| M8_solo_finbert | 6 | 0.4989 | 0.502 | 0.168 | 0.202 | 0/6 | no |
...
### M7_todas_finbert — AUC por fold

| test year | n | AUC | acc | prec | recall |
|---|---|---|---|---|---|
| 2017 | 26241 | 0.502 | 0.500 | 0.511 | 0.483 |
| 2018 | 56280 | 0.496 | 0.498 | 0.504 | 0.601 |
| 2019 | 23398 | 0.498 | 0.489 | 0.476 | 0.071 |
| 2020 | 29772 | 0.503 | 0.496 | 0.490 | 0.707 |
| 2021 | 28631 | 0.497 | 0.491 | 0.481 | 0.646 |
| 2022 | 22868 | 0.494 | 0.482 | 0.474 | 0.188 |

Top features (importance): finbert_msg_count(0.065), bullish_ratio(0.058), bb_width(0.058), volatility_20d(0.058), finbert_net_sentiment_mean(0.058), finbert_prob_neg_mean(0.057), macd_hist(0.057), unique_users(0.053), total_count(0.052), bb_pct(0.052)

### M8_solo_finbert — AUC por fold

| test year | n | AUC | acc | prec | recall |
|---|---|---|---|---|---|
| 2017 | 26241 | 0.501 | 0.511 | 0.511 | 0.953 |
| 2018 | 56280 | 0.492 | 0.491 | 0.497 | 0.261 |
| 2019 | 23398 | 0.500 | 0.493 | 0.000 | 0.000 |
| 2020 | 29772 | 0.500 | 0.510 | 0.000 | 0.000 |
| 2021 | 28631 | 0.500 | 0.516 | 0.000 | 0.000 |
| 2022 | 22868 | 0.500 | 0.492 | 0.000 | 0.000 |

Top features (importance): finbert_prob_neg_mean(0.341), finbert_net_sentiment_mean(0.338), finbert_msg_count(0.321)
